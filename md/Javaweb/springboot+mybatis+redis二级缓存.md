 ...
 * @PackageName: com.bingchunmoli.api.utils
 * @Version 0.0.1-SNAPSHOT
 **/
@Component
...
# Redis实现Mybatis的Cache作为Mybatis的二级缓存
...
RedisCache是自己实现Mybatis的Cache接口的实现类
